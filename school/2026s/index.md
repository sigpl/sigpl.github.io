            ...
            <table border="0" cellspacing="1pt">
              <tbody>
                ...
                <tr>
                  ...
                  <td bgcolor="white"> 번개 발표 (1인 5분) </td>
                </tr>
                <tr>
...
<table border="0" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td bgcolor="white"> 스파이킹 신경망이 교묘하게 바꾼 입력에도 속지 않는지 빠르게 확인하기 </td>
...
<ul>
  ...
  <li><b>유의 사항</b>
      <ul>
          ...
          <li>참가확인서가 필요한 분들은 행사 종료 후 한국정보과학회(담당: <a href="mailto:ejmoon@kiise.or.kr">문은정 차장</a>)에 이메일로 요청해 주십시오.</li>
      </ul>
  </li>
</ul>
...
하이퍼엑셀은 생성형 AI 추론(Inference)에 최적화된 LPU(LLM Processing Unit)를 개발하는 대한민국의 AI 반도체 스타트업입니다. 자체 개발한 AI 가속기와 소프트웨어 스택을 통해 대규모 언어모델(LLM)과 생성형 AI 서비스를 GPU 대비 더 높은 전력 효율과 비용 효율로 구현하며, 하드웨어부터 컴파일러·런타임까지 전 영역을 아우르는 시스템 최적화로 데이터센터부터 엣지 AI까지 다양한 환경에서 AI 인프라 혁신을 이끌고 있습니다. 네이버클라우드, LG전자, 삼성전자, 세미파이브, 어드밴텍, 인벤텍, HPE 등 국내외 주요 기업들과 협력하며 글로벌 AI 생태계를 확장하고 있으며, LPU 아키텍처 연구로 IEEE Micro 최우수 논문상(2025)을 수상하고 IEEE/ACM DAC 2023 공학부문 최고 발표상, 대만 ICTGC AI 코어 기술 부문 수상(2025) 등 세계적인 학회에서 기술력을 인정받았습니다. AI 인프라의 전력과 비용 문제를 하드웨어와 소프트웨어의 긴밀한 co-design으로 풀어가는 차세대 AI 반도체 기업으로서, 글로벌 시장에서 새로운 표준을 만들어가고 있습니다.
 ...
 <tr><th colspan="2" align="left"> 브론즈 후원사</th></tr>
  <tr>
    <td bgcolor="white"><img src="sponsor/tenx.png" width="200"></td>
    <td bgcolor="white" style="width:800">
TenX Semi는 반도체 설계와 검증의 개발 속도를 10배 이상 높이고 디자인의 quality를 향상시키는 "Design & Verification AI Agent" 를 개발합니다. 스탠포드 Mitra 교수 연구그룹의 Formal Verification 알고리즘을 원천 기술로 하여, 기존 팹리스들이 잡기 어려웠던 Long-tail 버그 검증부터 Automatic Chip Design까지 반도체 설계의 미래를 혁신합니다. 2025년 설립되어 Stanford/서울대/KAIST 출신은 물론 Samsung, Google, Apple, Synopsys, Cadence, Broadcom, Qualcomm 등 글로벌 빅테크 출신의 최고 수준 전문가들로 팀이 구성되어 있으며, 기술력을 인정받아 미국 Tier-1 VC의 투자를 유치하며 빠르게 성장하고 있습니다.
  ...
  <tr>
    ...
    <td bgcolor="white" style="width:800"> 업스테이지는 문서 AI와 자체 개발 LLM을 하나의 스택으로 수직 통합한 대한민국 대표 풀스택 AI 기업입니다. 소형·고효율 언어모델 Solar는 적은 파라미터로도 프런티어급 추론 성능을 내며, 온프레미스·프라이빗 클라우드 배포까지 지원해 데이터 주권이 중요한 금융·제조·공공 조직이 실무에 투입하고 있습니다. 문서 AI(Document Parse·Extract·Classify)는 글로벌 OCR·VQA 벤치마크 최상위권 성능과 90% 이상의 복잡 문서 파싱 정확도로 비정형 문서를 즉시 자동화 가능한 구조화 데이터로 바꾸며, 노코드 플랫폼 Upstage Studio를 통해 에이전트와 문서 파이프라인을 코드 없이 구축·배포·모니터링할 수 있습니다. 현재 금융·제조·공공을 아우르는 산업 전반에서 200곳 이상의 엔터프라이즈가 업스테이지의 AI 스택을 운영하고 있습니다. 국산 AI 반도체 위에서 효율적으로 구동되는 소버린 AI 스택을 지향하며, 대한민국이 자체 기술로 완결된 AI 인프라를 갖추는 데 앞장서고 있습니다.
    </td>
  </tr>
