...
$content = 
  'head | 2/9(월) | 발표자 | 좌장 ##
   ...
   4:30-5:30 | 초청 강연 | 김종헌 대표 (Peace of Mind) ##
...
<tr align="center"><th>등록비</th><td>150,000원</td><td>200,000원</td><td>250,000원</td></tr>
 ...
 <li> 등록 방법: <font color="red">2월 7일</font>까지 <a href="/pay/school.php">등록페이지</a>를 통하여 등록
</ul>

<h2> 준비위원회 </h2>
<ul>
<li> 학술위원장: 창병모 교수 (숙명여자대학교)
  <li> 조직위원장: 방기석 교수 (한림대학교)
  <li> 후원: 한림대학교 정보전자공과대학 컴퓨터공학과
  <li> 문의: 방기석 교수 (한림대학교, 017-399-1648, <img src="/mail/mysaver.jpg">)<br>
  &nbsp; &nbsp; &nbsp; &nbsp;  안준선 교수 (한국항공대학교, 017-208-5593, <img src="/mail/jsahn.jpg">)
</ul>

  <h2> 장소안내: <a href="http://www.hallym.ac.kr/mediator/medi06/medi06_5.html" target="_blank">한림대학교 오시는 길</a> </h2>

<center>
<img src="hallym_map11.gif">
</center>
<ul>
<li>서울·경기 지역에서 오시는 길
<ul>

   <li> 자가용을 이용할 경우 경춘국도를 타고 약 3km정도 가면 도농삼거리가 나오는데 거기서
     금곡, 마석, 춘천방향으로 좌회전한 후 그 길 따라 약 1시간 30분 정도 오면 춘천입니다.
     지도의 빨간색 도로를 따라 오면 됩니다.

   <li> 시외버스를 이용할 경우 구의동 동서울터미널(지하철 2호선 강변역 앞)이나 상봉터미널
     에서 춘천행 버스를 타시면 됩니다. 첫차는 5시 30분에 있으며, 배차간격은 10분~15분
     입니다. 1시간 30분에서 1시간 45분 정도 소요됩니다.
     김포공항에서도 춘천까지 운행하는 시외버스가 있습니다. 버스터미널에서 대중교통을
     이용해서 한림대학교에 오시면 됩니다.

   <li> 기차편을 이용하시는 경우 청량리역이나 성북역에서 경춘선을 타시고 종착역인 남춘천역
...
자가용을 이용하시는 경우 경부고속도로 및
   ...
   이용하셔도 됩니다.
<li> 경기도와 충청북도에서는 도내 많은 지역에서 춘천행 시외버스를 이용하실 수 있습니다.
